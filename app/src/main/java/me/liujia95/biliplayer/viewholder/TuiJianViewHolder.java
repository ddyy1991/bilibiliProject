...
public class TuiJianViewHolder extends RecyclerView.ViewHolder {
    ...
    public TuiJianViewHolder(View parent) {
        super(parent);
        mIcon=parent.findViewById(R.id.item_tuijian_icon);
        mTitle=parent.findViewById(R.id.item_tuijian_title);
        mNumber=parent.findViewById(R.id.item_tuijian_number);
        mFav=parent.findViewById(R.id.item_tuijian_fav);
    }
