...
public class FaxianCenterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public FaxianCenterViewHolder(View itemView) {
        super(itemView);
        mWiki=itemView.findViewById(R.id.faxian_center_wiki);
        mTv=itemView.findViewById(R.id.faxian_center_tv);
        mIvArrow=itemView.findViewById(R.id.faxian_bottom_arrow);
        mContainer=itemView.findViewById(R.id.faxian_center_container);
